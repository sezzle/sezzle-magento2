...
- Re-read the cart before retrying order placement, so a retry starts from committed data rather than from a cart left half-converted by the failed attempt
