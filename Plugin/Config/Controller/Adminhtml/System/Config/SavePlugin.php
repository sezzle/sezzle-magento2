...
class SavePlugin
{
    ...
    private function getOldConfig(): array
    {
        return [
            ...
            SezzleConfig::KEY_EXPRESS_CHECKOUT =>
                $this->config->getConfigDataValue($this->getPath(SezzleConfig::KEY_EXPRESS_CHECKOUT)),
    ...
    private function getNewConfig(array $oldConfig, array $configGroups): array
    {
        ...
        return [
            ...
            'express_checkout' => !isset($paymentFields[SezzleConfig::KEY_EXPRESS_CHECKOUT])
                ? (bool)$oldConfig[SezzleConfig::KEY_EXPRESS_CHECKOUT]
                : ($this->isInherit(SezzleConfig::KEY_EXPRESS_CHECKOUT, $paymentFields)
                    ? (bool)$oldConfig[SezzleConfig::KEY_EXPRESS_CHECKOUT]
                    : (bool)$paymentFields[SezzleConfig::KEY_EXPRESS_CHECKOUT]['value']),
