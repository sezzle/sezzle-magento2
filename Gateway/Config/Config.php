...
class Config extends PaymentConfig
{
     ...
     */
    public function isEnabled(int|null $storeId): bool
    {
     ...
     * @throws NoSuchEntityException
     */
    public function getPublicKey(int|null $storeId): ?string
    {
     ...
     * @throws NoSuchEntityException
     */
    public function getPrivateKey(int|null $storeId): ?string
    {
        return $this->getValue(
     ...
     * @throws NoSuchEntityException
     */
    public function getMerchantUUID(int|null $storeId): ?string
    {
        return $this->getValue(
     ...
     * @throws NoSuchEntityException
     */
    public function getPaymentMode(int|null $storeId): string
    {
        return $this->getValue(
     ...
     * @throws NoSuchEntityException
     */
    public function getPaymentAction(int|null $storeId): string
    {
        return $this->getValue(
     ...
     * @throws NoSuchEntityException
     */
    public function getMinCheckoutAmount(int|null $storeId): ?float
    {
        return $this->getValue(
     ...
     * @throws NoSuchEntityException
     */
    public function isTokenizationEnabled(int|null $storeId): bool
    {
        return (bool)$this->getValue(
            self::KEY_TOKENIZE,
            $storeId ?? $this->storeConfigResolver->getStoreId()
     ...
     * @throws NoSuchEntityException
     */
    public function isWidgetEnabledForPDP(int|null $storeId): bool
    {
        return (bool)$this->getValue(
            self::KEY_WIDGET_PDP,
            $storeId ?? $this->storeConfigResolver->getStoreId()
     ...
     * @throws NoSuchEntityException
     */
    public function isWidgetEnabledForCart(int|null $storeId): bool
    {
        return (bool)$this->getValue(
     ...
     * @throws NoSuchEntityException
     */
    public function getWidgetTicketCreatedAt(int|null $storeId): ?string
    {
        return $this->getValue(
     ...
     * @throws NoSuchEntityException
     */
    public function isInstallmentWidgetEnabled(int|null $storeId): bool
    {
        return (bool)$this->getValue(
     ...
     * @throws NoSuchEntityException
     */
    public function getInstallmentWidgetPricePath(int|null $storeId): ?string
    {
     ...
     * @throws NoSuchEntityException
     */
    public function isLogsSendingToSezzleAllowed(int|null $storeId): bool
    {
        return (bool)$this->getValue(
            self::KEY_CRON_LOGS,
            $storeId ?? $this->storeConfigResolver->getStoreId()
     ...
     * @throws NoSuchEntityException
     */
    public function isSettlementReportsEnabled(int|null $storeId): bool
    {
        return (bool)$this->getValue(
     ...
     * @throws NoSuchEntityException
     */
    public function getSettlementReportsRange(int|null $storeId): bool
    {
        return (bool)$this->getValue(
     ...
     * @throws NoSuchEntityException
     */
    public function isInContextModeActive(int|null $storeId): bool
    {
        return (bool)$this->getValue(
     ...
     * @throws NoSuchEntityException
     */
    public function getInContextMode(int|null $storeId): ?string
    {
        return $this->getValue(
